...
import com.huseyin.jobportal.services.RecruiterProfileService;
import com.huseyin.jobportal.util.FileUploadUtil;
    ...
    public String recruiterProfile(Model model){
        ...
        if (!(authentication instanceof AnonymousAuthenticationToken)){
            ...
            Users users =usersRepository.findByEmail(currentUsername).orElseThrow(()->new
                    UsernameNotFoundException("Could not find the user"));
